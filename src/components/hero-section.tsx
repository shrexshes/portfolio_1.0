...
const HeroSection = () => {
    ...
    useEffect(() => {
        const startHeroAnim = () => {
            ...
            // Set a CSS variable to trigger all nested animations simultaneously 
            // but controlled by their individual CSS transition-delays
        ...
        // Fallback: trigger after 3s if loader event never fires
    ...
    // Shared transition class to keep the code clean
    ...
    return (
        ...
        >
            ...
            <div className="z-20 text-center px-4 max-w-6xl mt:10 md:mt-20 mx-auto flex flex-col gap-5 items-center">
                ...
                <h1 className="text-5xl md:text-7xl font-bold uppercase tracking-tighter flex items-center flex-col text-center font-host leading-[1]">
                    <span 
                        style={{ opacity: 'var(--hero-opacity)', filter: 'blur(var(--hero-blur))', transitionDelay: '400ms' }}
