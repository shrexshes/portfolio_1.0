...
const HeroSection = () => {
    ...
    return (
        <section ref={containerRef} className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-gray-900/60 text-white selection:bg-gray-500/30">
            ...
            {/* <div className="absolute inset-0 bg-gradient-to-t from-transparent via-gray-950/80 to-gray-950 z-10" /> */}
            ...
            <div className="hero-side-element absolute left-8 top-1/2 -translate-y-1/2 hidden md:flex flex-col gap-8 items-start text-gray-400 font-jet text-xs pointer-events-none z-30">
                <div className="h-24 w-[1px] bg-gradient-to-b from-transparent via-gray-300 to-transparent"></div>
            ...
            <div className="hero-side-element absolute right-8 top-1/2 -translate-y-1/2 hidden md:flex flex-col gap-8 items-end text-gray-300 font-jet text-xs z-30">
                <div className="h-24 w-[1px] bg-gradient-to-b from-transparent via-gray-300 to-transparent"></div>
            ...
            {/* Corner Accents */}
            <div className="absolute top-8 left-8 w-4 h-4 border-l border-t border-gray-100 opacity-50"></div>
            <div className="absolute top-8 right-8 w-4 h-4 border-r border-t border-gray-100 opacity-50"></div>
            <div className="absolute bottom-8 left-8 w-4 h-4 border-l border-b border-gray-100 opacity-50"></div>
            <div className="absolute bottom-8 right-8 w-4 h-4 border-r border-b border-gray-100 opacity-50"></div>


            {/* --- Main Content --- */}
            <div className="z-20 text-center px-4 max-w-4xl mt-20 mx-auto flex flex-col items-center">

                {/* Status Badge */}
                <div className="hero-badge inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/10 backdrop-blur-sm text-sm font-jet text-gray-300 mb-2">
                ...
                {/* Headline */}
                <h1 ref={bgText} className="font-bold font-inter tracking-tighter leading-[0.8] md:leading-[1]">
                    <span className="hero-headline-1 text-[4rem] md:text-[8rem] inline-block">Upgrading </span>
                    <br />
                    <span className="hero-headline-2 text-[3rem] md:text-[8rem] bg-clip-text text-transparent flex items-center gap-2 bg-gradient-to-b from-white via-white to-white/40 ">
                        digital <Image width={300} height={300} alt="mac image" className="w-20 md:w-30 " src="/images/mac.png" /> future
                    </span>  <br />
                ...
                {/* Sub-headline */}
                <p className="hero-text text-lg md:text-xl text-white font-jet max-w-2xl mt-6 mx-auto leading-relaxed">
