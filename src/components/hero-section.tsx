...
const HeroSection = () => {
    ...
    return (
        <section ref={containerRef} className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-slate-900/90 text-white selection:bg-slate-500/30">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-slate-500/10 rounded-full blur-[100px] z-0"></div>
            ...
            {/* <div className="absolute inset-0 bg-gradient-to-t from-transparent via-slate-950/80 to-slate-950 z-10" /> */}
            ...
            <div className="hero-side-element absolute left-8 top-1/2 -translate-y-1/2 hidden md:flex flex-col gap-8 items-start text-slate-400 font-jet text-xs pointer-events-none z-30">
                <div className="h-24 w-[1px] bg-gradient-to-b from-transparent via-slate-300 to-transparent"></div>
            ...
            <div className="hero-side-element absolute right-8 top-1/2 -translate-y-1/2 hidden md:flex flex-col gap-8 items-end text-slate-300 font-jet text-xs z-30">
                <div className="h-24 w-[1px] bg-gradient-to-b from-transparent via-slate-300 to-transparent"></div>
            ...
            {/* Corner Accents */}
            <div className="absolute top-8 left-8 w-4 h-4 border-l border-t border-slate-100 opacity-50"></div>
            <div className="absolute top-8 right-8 w-4 h-4 border-r border-t border-slate-100 opacity-50"></div>
            <div className="absolute bottom-8 left-8 w-4 h-4 border-l border-b border-slate-100 opacity-50"></div>
            <div className="absolute bottom-8 right-8 w-4 h-4 border-r border-b border-slate-100 opacity-50"></div>
            ...
            <div className="z-20 text-center px-4 max-w-4xl mx-auto flex flex-col items-center gap-6">
                ...
                <div className="hero-badge inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/10 backdrop-blur-sm text-sm font-jet text-slate-300 mb-2">
                    <span className="relative flex h-2 w-2">
                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-slate-400 "></span>
                ...
                <p className="hero-text text-lg md:text-xl text-white font-jet max-w-2xl mx-auto leading-relaxed">
                    ...
                    <span className="text-white decoration-slate-500 underline underline-offset-4">
                        performance
                    </span>{" "}
                    and{" "}
                    <span className="text-white decoration-slate-500 underline underline-offset-4">
                ...
                <div className="hero-buttons flex flex-col sm:flex-row items-center gap-4 mt-4">
                    ...
                    <button className="group relative px-8 py-4 bg-white text-black font-jet font-bold text-sm tracking-wide overflow-hidden">
                        ...
                        <div className="absolute inset-0 bg-slate-400 transform scale-x-0 origin-left transition-transform duration-300 group-hover:scale-x-100 z-0"></div>
                    </button>

                    {/* Secondary Button */}
                    <button className="px-8 py-4 bg-transparent border border-slate-700 text-white font-jet text-sm hover:bg-slate-800 transition-all duration-300 flex items-center gap-2">
