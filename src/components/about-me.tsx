        ...
        >
            ...
            <div className="relative z-10 w-full max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-8 order-2 md:order-1">
                    <TextReveal>
                        <h3 className="text-4xl md:text-5xl font-bold text-white font-inter">
                            Beyond the <span className="text-slate-300">Lines of Code</span>
                        </h3>
                    </TextReveal>

                    <div className="space-y-6 font-jet text-lg text-slate-400 leading-relaxed placeholder-opacity-80">
                ...
                >
                    ...
                    <div className="relative w-full max-w-md backdroop-blur-md aspect-[5/5] bg-slate-600/80 border border-slate-800 overflow-hidden">
                        {/* Grid Decoration */}
                        ...
                        <div className="absolute bottom-0 -left-12 w-40 h-40 bg-slate-100 mix-blend-overlay opacity-90 blur-2xl rounded-full"></div>
                    ...
                    {/* Accent Overlay Box */}
                    <div className="absolute -bottom-6 -left-6 w-[50%] bg-radial from-slate-700 to-slate-500 py-5 border border-slate-700 z-20 flex items-center justify-center ">
                        <h3 className="text-sm px-5 md:text-medium text-slate-200 tracking-tighter font-jet">
