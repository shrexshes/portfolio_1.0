...
const ZenFooter = () => {
    ...
    return (
        ...
        <footer className="relative bg-black min-h-[60vh] py-10 md:py-20 px-5 md:px-20 overflow-hidden border-t border-white/10 flex items-center">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-16">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-2">
                            ...
                            <h2 className="text-3xl md:text-5xl font-host font-bold text-white tracking-tighter uppercase leading-none">
                                Ayush<span className="text-red-600 ml-3">.</span>
                            </h2>
                        </div>

                        <div className="space-y-4">
                            <p className="text-white font-inter text-sm md:text-lg max-w-[500px] leading-relaxed">
                    ...
                    <div className="flex flex-col items-start md:items-end gap-12 w-full md:w-auto">
                        ...
                        <div className="flex flex-col items-start md:items-end gap-4">
                            ...
                            <div className="flex flex-col md:items-end gap-1">
                                <span className="text-white  font-jet text-sm font-bold uppercase ">
